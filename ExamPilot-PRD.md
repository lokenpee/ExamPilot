...
**一句话定位**：ExamPilot 是资料驱动的 AI 组卷与自测 Agent——上传课程、培训或产品资料，先规划、后出题，每道题可追溯到原文，最终导出学生版试卷和教师版答案解析。

**它解决的核心问题**：无论是教师给学生出卷、学生用课件自测，还是产品/销售经理做培训考核，出题都不是“随便生成几道题”，而是一组连续决策：考哪些知识点、用什么题型和分值、难度如何分布、每道题的依据在哪里、试卷和答案如何分开交付。ExamPilot 把这组决策组织成可确认、可修改、可追溯的流程。
...
| 核心能力 | 典型用户场景 | 用户得到什么 |
| --- | --- | --- |
| 资料驱动知识提取 | 教师、学生、产品/销售经理手里有课件、教材、产品资料或培训手册，不想手动整理知识点 | 从 PDF／PPTX／DOCX 提取文本、知识点和原文定位 |
| 结构化组卷规划 | 出题人需要先定题型、题数、分值和难度，而不是直接出题 | 一份可对话调整的整卷规划，明确每个题槽考什么 |
| 证据可追溯出题 | 出题人需要确认题目不是模型凭空编造 | 每题附答案、解析、知识点和 MCP 检索到的原文引用 |
| 人机协同编辑与补题 | 出题人对个别题目不满意，但不想重做整卷 | 删除后对话补题，候选可多轮修改，采纳后才入卷 |
| 双版本 Word 导出 | 教师要把试卷发给学生，或培训负责人要把试卷发给销售人员 | 学生版无答案／无解析；教师版含答案、解析和引用依据 |
| 学生自测与复习 | 学生上传教材或课件，生成练习题和答案用于复习 | 一套可自测的试卷与可核对的答案解析 |
| 业务培训考核 | 产品/销售经理上传产品手册、销售话术或合规资料 | 产品知识／销售话术／合规考核卷及标准答案 |

**核心用户**：高校教师/培训讲师、学生/学习者、产品/销售经理、企业培训/L&D 负责人。  
**典型场景**：课程测试、学生自测、产品知识/销售话术/合规考核、企业内训。  
**次要演示用户**：产品评审、面试官、需要展示 Agent 工作流的观众。  
**可扩展场景**：教研组共享题库、考证备考、客户培训（首版提供通用资料驱动流程，不提供垂直行业模板）。
...
1. **给资料**：上传课程、培训或产品资料（文字型 PDF／PPTX／DOCX），并设置题型、总分、时长和难度比例。
2. **看方案**：AI 先给出整卷规划；出题人可对话调整知识点与难度，确认后再生成具体题目。
3. **导出卷**：出题人审阅、编辑或补题；检查通过后，一次导出学生版和教师版两个 Word 文件。

## 文档信息

| 项目 | 内容 |
| --- | --- |
| 产品名称 | ExamPilot · AI 组卷与自测 Agent |
| 版本 | v0.3 · Demo 开发基线草案 |
| 更新日期 | 2026-09-15 |
...
教师、学生和业务负责人需要反复查看教材、课件、产品资料或培训手册，手动安排题型、知识点覆盖、难度与分数，还要编写答案解析并核对依据。ExamPilot 将这一过程组织为“规划 → 出题 → 修改”，让出题人先确认方案，再审阅有资料依据的试卷或自测题。

🔶 假设：上述场景具有明显的重复劳动，且引用定位能降低出题人核对成本。当前没有访谈样本、人工耗时基线或真实教学效果数据；求职展示中应将其表述为待验证的产品假设。

### 1.2 本期目标

1. 用户上传资料、配置结构，得到可解释且可调整的组卷方案。
...
| 范围 | 本期安排 |
| --- | --- |
| 主要用户 | 高校教师/培训讲师、学生/学习者、产品/销售经理、企业培训/L&D 负责人；首版提供通用资料驱动流程，不提供垂直行业模板 |
| 题型 | 单选、多选、判断、填空、简答、计算全部纳入；先打通单选纵向流程，再扩展其他题型 |
| 输入 | 课程、培训、产品资料等文字型 PDF、PPTX、DOCX；往年试卷按同一资料管线处理 |
...
| US-07 | 作为学生/学习者，我希望用教材或课件生成自测题和答案，用于复习 | 一套可自测的试卷和可核对的答案解析 |
| US-08 | 作为产品/销售经理，我希望把产品资料、销售话术和合规要求转成培训考核 | 与内部资料一致的产品知识／销售话术／合规考核卷和标准答案 |
...
同一套流程可直接替换为其他场景：学生把教材/课件作为资料，配置自测卷并导出答案版；产品/销售经理把产品手册、销售话术或合规资料作为输入，生成培训考核卷。产品不要求用户预先选择“教师/学生/销售”角色，也不为不同角色维护两套流程。

## 三、核心流程与状态

> 说明：后文为便于描述，将发起组卷的操作者统称为“教师/出题人”；同一流程同样适用于学生自测、产品/销售培训考核和企业内训，角色与资料类型可以替换。
